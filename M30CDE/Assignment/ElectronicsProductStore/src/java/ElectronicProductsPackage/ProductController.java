...
import ElectronicProductsPackage.util.JsfUtil;
import ElectronicProductsPackage.util.PaginationHelper;
...
public class ProductController implements Serializable {
    ...
    @EJB
    private ElectronicProductsPackage.ProductFacade ejbFacade;
