...
/**    A SafeArray class manipulates array of integer numbers.  
  ...
  private int currentSize; 
   ...
   /**         Constructor creates array of given size.       @param maxSize the array length    */   
   ...
   /**       Add a given value at the current available position in the store.       @param value the given value       @return true if successful else false    */ 
   ...
   /**       Sort store array into decending order using bobble sort algorithm.    */ 
      public void bobbleSort()  
       ...
       /**       Swop the two elements - a helper method       @param i first index       @param j second index    */  
