...
/**
 *
 * @param args Arguments passed when application has been started
 */
public static void main(String[] args) 
{
    ...
    PrintTestResultBool(
            "Get aircraft with existing",
            true,
            testAircraft != null);
    Aircraft newAircraft = AircraftHelper.genAircraft();
    testAircraft = operationsList.get(newAircraft.getReg());
    PrintTestResultBool(
            "Get aircraft without existing", 
            true, 
            testAircraft == null);
    try {
        operationsList.get(null);
        PrintTestResultException(
                "Get aircraft, throws exception Failed", 
                null);
    } catch (Exception e) {
        PrintTestResultException(
                "Get aircraft, throws exception Passed",
                e);
    }
    //Testing remove()
    ...
    try {
        ...
        PrintTestResultException(
                "Remove aircraft, throws exception Passed",
                e);
    }
    ...
    System.out.println("** List after sort: Excpected result - sorted by "
            + "alphabetical order on flight reg");
    operationsList.sort();
    System.out.println(operationsList.toString());
...
/**
 * Helper to display correct test output in correct format
 * @param operation The operation being performed
 * @param excpected The expected output
 * @param actual The actual output
 */
public static void PrintTestResultBool(
        String operation,
        boolean excpected,
        boolean actual) {
    ...
    System.out.println(
            String.format(
                    "Operation: %s - Excpected: %s - Actual: %s",
                    operation,
                    excpected,
                    actual));
}
...
/**
 * Helper to display correct test output in correct format
 * @param operation The Operation being perofmred
